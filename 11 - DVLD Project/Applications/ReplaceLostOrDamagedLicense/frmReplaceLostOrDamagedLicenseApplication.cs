...
using static DVLD___Business_Layer.clsLicense;

namespace _11___DVLD_Project.Applications.ReplaceLostOrDamagedLicense
{
    public partial class frmReplaceLostOrDamagedLicenseApplication : Form
    {
        ...
        private void rbDamagedLicense_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = clsApplicationType.Find(_GetApplicationTypeID()).ApplicationTypesFees.ToString();
        }
