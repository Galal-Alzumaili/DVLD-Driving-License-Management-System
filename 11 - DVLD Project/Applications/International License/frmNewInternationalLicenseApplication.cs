...
namespace _11___DVLD_Project.Applications.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblFees.Text = clsApplicationType.Find((int)clsApplication.enApplicationType.NewInternationalLicense).ApplicationTypesFees.ToString();
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            ...
            InternationalLicense.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.NewInternationalLicense).ApplicationTypesFees;
