...
namespace DVLD___Business_Layer
{
    public class clsLicense
    {
        ...
        public clsLicense(int LicenseID, int ApplicationID, int DriverID, int LicenseClass, DateTime IssueDate, DateTime ExpirationDate, string Notes, float PaidFees, bool IsActive, enIssueReason IssueReason, int CreatedByUserID)
        {
        ...
        public static clsLicense Find(int LicenseID)
        {
            ...
            byte IssueReason = 1;
            if (clsLicenseData.GetLicenseByLicenseID(LicenseID, ref ApplicationID, ref DriverID, ref LicenseClass,
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID, ref int ApplicationID)
        {
            ...
            Application.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicsense).ApplicationTypesFees;
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.RenewDrivingLicense).ApplicationTypesFees;
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.Find(Application.ApplicationTypeID).ApplicationTypesFees;
            Application.CreatedByUserID = CreatedByUserID;
