...
namespace DVLD___Business_Layer
{
    public class clsApplication
    {
        ...
        public static clsApplication Find(int ApplicationID)
        {
            ...
            if (clsApplicationData.GetApplicationByApplicationID(ApplicationID, ref ApplicantPersonID, ref ApplicationDate, ref ApplicationTypeID, ref ApplicationStatus, ref LastStatusDate, ref PaidFees, ref CreatedByUserID))
        ...
        public static clsApplication IsLocalApplicationIsAlreadyThere(int PersonID, int LicenseClassID)
        {
            int ApplicationID = -1, ApplicationTypeID = -1, ApplicationStatus = 0, CreatedByUserID = -1;

            DateTime ApplicationDate = DateTime.Now, LastStatusDate = DateTime.Now;
            float PaidFees = 0;


            if (clsApplicationData.GetApplicationByPersonIDAndLicenseClassID(ref ApplicationID, PersonID, LicenseClassID))
                return new clsApplication(ApplicationID, PersonID, ApplicationDate, ApplicationTypeID, (enApplicationStatus)ApplicationStatus, LastStatusDate, PaidFees, CreatedByUserID);
            else
                return null;
        }

        public static bool DeleteUser(int ApplicationID)
        {
